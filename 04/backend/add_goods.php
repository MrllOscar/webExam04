...
<table class="all">
  ...
  <tr>
    ...
    <td class="pp"><span id="showNo">完成分類後自動分配</span><input type="hidden" name="no" value=""></td>
  </tr>
  <tr>
...
<div class="ct">
<input type="submit" value="新增"><input type="reset" value="重置"><input type="button" value="返回" onclick="loaction.href='?do=th'"></div>
</form>
...
<script>
  ...
  function getNo(){
    Math.floor(Math.random()*899998)+100000;
    $("#no").val(no);
      $('#showNo').text(no)
